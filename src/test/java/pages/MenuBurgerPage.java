...
public class MenuBurgerPage extends BasePage {
    ...
    public void waitPageToLoad() {
        ...
        Logs.info("Esperando que sea clickeable por la animación");
    ...
    public void verifyAboutLink(String expectedUrl){
        ...
        Assertions.assertAll(
                ...
                () -> Assertions.assertEquals(aboutLabel.getAttribute("href"), expectedUrl)
